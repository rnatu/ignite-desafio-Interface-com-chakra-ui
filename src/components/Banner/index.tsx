  ...
  return (
    <Flex h={['10.18rem', '13.rem', '23rem']}>
      <Box
        ...
        height={['10.18rem', '23rem', '35rem']}
      >
        <Flex
          mt={['1.75rem', '20rem', '23rem']}
          px={['1rem', '20rem', '23rem']}
          justify="space-between"
        >
          <Box color="gray.50" w="32.75rem">
            <Text fontSize={['1.25rem', '20rem', '23rem']} fontWeight="500">
              5 Continentes, <br />
